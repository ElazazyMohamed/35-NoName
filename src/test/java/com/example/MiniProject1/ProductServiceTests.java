...
//
//    @Test
//    void WhenProductIsNull_addProduct_ShouldThrowServiceException() {
...
//        );
//
//        assertEquals("Product details cannot be null!", thrown.getMessage());
//        verify(productRepository, never()).addProduct(any(Product.class));
//    }
//
//    @Test
//    void WhenProductAlreadyExists_addProduct_ShouldThrowResourceNotFoundException() {
//        Product existingProduct  = new Product(UUID.randomUUID(), "Laptop", 1000.0);
//        when(underTest.getProductById(existingProduct.getId())).thenReturn(existingProduct);
//
//        ResourceNotFoundException thrown = assertThrows(
//                ResourceNotFoundException.class,
//                () -> underTest.addProduct(existingProduct),
//                "Expected addProduct to throw ResourceNotFoundException, but it didn't"
//        );
//
...
//        when(underTest.getProductById(newProduct.getId())).thenReturn(null);
//
//        doThrow(new DatabaseException("Database error occurred while adding product"))
...
//        );
//
//        assertEquals("Database error occurred while adding product", thrown.getMessage());
...
//        UUID productId = UUID.randomUUID();
//        doThrow(new DatabaseException("Database error occurred while getting user"))
...
//        );
//
//        assertEquals("Product list cannot be null or empty!", thrown.getMessage());
...
//
//    @Test
//    void WhenProductDoesNotExist_deleteProductById_ShouldNotThrowException() {
//        UUID productId = UUID.randomUUID();
//
//        doNothing().when(productRepository).deleteProductById(productId);
//
...
//
//    @Test
//    void WhenProductIdIsNull_deleteProductById_ShouldThrowServiceException() {
//        ServiceException thrown = assertThrows(
//                ServiceException.class,
//                () -> underTest.deleteProductById(null),
//                "Expected deleteProductById to throw ServiceException, but it didn't"
//        );
//
//        assertEquals("Product ID cannot be null!", thrown.getMessage());
//
//        verify(productRepository, never()).deleteProductById(any());
//    }
//}
